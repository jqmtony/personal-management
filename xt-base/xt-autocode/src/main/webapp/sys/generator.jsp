				...
				<td>
					<div id="step2Panel">
						<fieldset style="border: 1px solid #ccc;font-size: 12px;">
						    ...
						    <table>
						    	<tr>
									<td>author: </td><td id="txt-author"></td>
						    		<td>package: </td><td id="txt-packageName"></td>
						    		<td>文件编码: </td><td id="txt-charset"></td>	
						    	</tr>
								<tr>
									<td>表名：</td><td id="txt-tableName"><input name="tableName" /></td>
									<td><button id="findTableBtn" type="button" onclick="queryTable();">查找</button></td>
								</tr>
						    </table>
						</fieldset>
					</div>
