 ...
 */
@Component
public class MasterDataSource implements CustomDataSource {
    ...
    public DataSource getDataSource() {
        if (dataSource == null) {
            ...
            dataSource.setDriverClassName(DbConfig.masterDriver);
            dataSource.setUrl(DbConfig.masterUrl);
            dataSource.setUsername(DbConfig.masterUsername);
            dataSource.setPassword(DbConfig.masterPassword);
