...
//    public static final String LUCENE_HOME_PATH = Constant.USER_HOME_PATH + Constant.PATH_SEPARATOR;
...
//            //按相关度排序
////            Sort.RELEVANCE
//            TopFieldCollector tfc = TopFieldCollector.create(sort, totalRecord,
//                    false /* fillFields */,
//                    true /* trackDocScores */,
//                    true /* trackMaxScore */,
//                    false /* docsInOrder */);
...
//            ScoreDoc[] scoreDocs = tfc.topDocs(first,max).scoreDocs;
...
//
//        /*IndexWriter indexWriter = getIndexWriter(indexDir,Analyzers.defaults(),CREATE_INDEX);//覆盖
//        for (int i = 1; i <= 3; i++) {
...
//            saveOrUpdateIndex(indexWriter,doc, CREATE_INDEX);
//        }
//        indexWriter.commit();
//        indexWriter.close();*/
//        //查询
//        List<Document> documents = search(indexDir, "content", "的", 10, Analyzers.defaults());
